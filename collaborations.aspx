<%@ Page Title="Events" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="collaborations.aspx.cs" Inherits="teressajohnsonstudio.collaborations" %>
...
protected void Page_Load(Object sender, EventArgs e)
    {
        ...
        args.AddParam("galleryType", "", "Collaborations");
